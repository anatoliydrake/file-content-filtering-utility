...
public class StatisticsPrinter {
    ...
    public void print(StatisticsCollector collector, StatsPrintingMode printingMode) {
        ...
        if (printingMode == StatsPrintingMode.FULL && intStats.getCount() > 0) {
        ...
        if (printingMode == StatsPrintingMode.FULL && floatStatistics.getCount() > 0) {
        ...
        if (printingMode == StatsPrintingMode.FULL && stringStatistics.getCount() > 0) {
